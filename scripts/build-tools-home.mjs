...
// only the two current workflows. The archived editor never enters this page.
...
const style=doc.createElement('style');style.textContent='.home-hero{max-width:1040px;margin:24px auto 0}.home-hero h1{font-size:30px;letter-spacing:-.7px}.task-grid{grid-template-columns:repeat(2,minmax(0,1fr));margin:24px 0 30px}.task-card{min-height:185px;border-radius:14px;padding:22px;box-shadow:none}.task-card h2{font-size:22px}.task-number{font-size:12px}.competition{margin-top:12px}.home-hero>.payment-shortcut{display:inline-flex;margin:16px 24px 0 0}.personal-shortcuts{margin:20px 0}@media(max-width:600px){.task-grid{grid-template-columns:1fr;gap:12px}.task-card{min-height:160px}.home-hero h1{font-size:26px}.home-hero>.payment-shortcut{display:flex;margin:12px 0}}';head.append(style);
...
console.log('Current launcher built: tools 03 and 04 only.');
