...
const knowledge=doc.createElement('a');knowledge.href='/knowledge';knowledge.target='_top';knowledge.className='knowledge-shortcut';
knowledge.innerHTML='<span><strong>Практика судов</strong><small>Найдите регион или суд и посмотрите динамику ВПС</small></span><span aria-hidden="true">Открыть →</span>';
grid.after(knowledge);
const knowledgeStyle=doc.createElement('style');knowledgeStyle.textContent='.knowledge-shortcut{display:flex;align-items:center;justify-content:space-between;gap:18px;text-align:left;padding:19px 22px;margin:-10px 0 28px;border:1px solid #d7e1da;border-radius:12px;background:#fff;color:#203622;text-decoration:none}.knowledge-shortcut strong{display:block;font-size:17px}.knowledge-shortcut small{display:block;color:#72806c;font-size:12px;margin-top:3px}.knowledge-shortcut>span:last-child{font-size:12px;white-space:nowrap}.knowledge-shortcut:hover{background:#f2f6ef;border-color:#9caf92}.knowledge-shortcut:focus-visible{outline:3px solid #377b4c;outline-offset:3px}@media(max-width:480px){.knowledge-shortcut{padding:17px}.knowledge-shortcut small{font-size:11px}}';head.append(knowledgeStyle);
const style=doc.createElement('style');style.textContent='.home-hero{max-width:1040px;margin:24px auto 0}.home-hero h1{font-size:30px;letter-spacing:-.7px}body[data-view=home] .task-grid{grid-template-columns:repeat(3,minmax(0,1fr));margin:24px 0 30px}body[data-view=home] .task-card{min-height:185px;border-radius:14px;padding:22px;box-shadow:none}.task-card h2{font-size:22px}.task-number{font-size:12px}.competition{margin-top:12px}.home-hero>.payment-shortcut{display:inline-flex;margin:16px 24px 0 0}@media(min-width:621px) and (max-width:850px){body[data-view=home] .task-grid{grid-template-columns:repeat(2,minmax(0,1fr))}body[data-view=home] .task-grid>.task-card:last-child{grid-column:1/-1;min-height:160px}}@media(max-width:620px){body[data-view=home] .task-grid{grid-template-columns:1fr;gap:12px}body[data-view=home] .task-card{min-height:160px}.home-hero h1{font-size:26px}.home-hero>.payment-shortcut{display:flex;margin:12px 0}}';head.append(style);
