...
import {httpHeaders} from './bitrix-headers-helper.mjs'; function load(file,imports){const exports={};vm.runInNewContext(ts.transpileModule(fs.readFileSync(file,'utf8'),{compilerOptions:{module:ts.ModuleKind.CommonJS,target:ts.ScriptTarget.ES2022}}).outputText,{exports,require:n=>n==='./http-headers'?httpHeaders:imports[n],AbortSignal,fetch:()=>{throw Error('Unexpected network')}});return exports;}
