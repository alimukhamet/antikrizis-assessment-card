...
async function reviewFixture(t,{saveOk=true,loseFirstResponse=false,count=1}={}){
 ...
 const plan={planKey:'stable-plan',plan:{activeLoans:count,balances:Array.from({length:count},(_,i)=>({fullIndex:i,creditor:'TEST BANK',aliases:[`CONTRACT-${i}-123`],contractNumber:`CONTRACT-${i}-123`,amount:'1250.25',shortPage:2,fullPage:7+i}))},decisions:[],rowHeads:Array.from({length:count},(_,i)=>({fullIndex:i,reviewId:null})),review:null};
