...
test('legacy combined answers migrate once without changing the original payload or losing metadata',()=>{
 for(const [keys,none,businessNone] of [[['none'],true,true],[['car'],undefined,true],[['land'],undefined,true],[['ip'],true,false],[['car','ip'],undefined,false],[['unknown'],undefined,false],[[],undefined,false]]){
